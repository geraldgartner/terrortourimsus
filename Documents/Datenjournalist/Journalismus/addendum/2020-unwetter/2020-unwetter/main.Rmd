...
```{r, echo=FALSE}
project_name <- "PROJECT_NAME" # adapt!
package_date <- "2020-02-18" # date of the CRAN snapshot used by checkpoint
R_version <- "3.6.1" # R-Version to use
...
if (!require(checkpoint)) {
  ...
  devtools::install_github("RevolutionAnalytics/checkpoint",
                           ref = "v0.4.1", # could be adapted later,
